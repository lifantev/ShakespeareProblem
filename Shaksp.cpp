...
int main(void)
{
	...
	//Lines* Line_t = (struct Lines*)calloc(how_much_lines, sizeof(Line_t[0]));
	...
	//Strings* String_t = (struct Strings*)calloc(how_much_lines, sizeof(String_t[0]));
