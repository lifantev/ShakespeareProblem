...
int anti_compare(const void *str1, const void *str2)
{
    ...
    for (int way1 = 0, way2 = 0; (way1 < minsize) && (way2 < minsize); )
    {
        ...
        if ((isalpha(*(*String_t1->strings_adresses + String_t1->strings_length - 1 - way1)) != 0) && (isalpha(*(*String_t2->strings_adresses + String_t2->strings_length - 1 - way2)) != 0))
        {
            if (*(*String_t1->strings_adresses + String_t1->strings_length - 1 - way1) == *(*String_t2->strings_adresses + String_t2->strings_length - 1 - way2))
            {
                way1++;
                way2++;
                continue;
            }
            else if (*(*String_t1->strings_adresses + String_t1->strings_length - 1 - way1) > *(*String_t2->strings_adresses + String_t2->strings_length - 1 - way2))
            {
                return 1;
                break;
            }
        ...
        else if ((isalpha(*(*String_t1->strings_adresses + String_t1->strings_length - 1 - way1)) == 0) && (isalpha(*(*String_t2->strings_adresses + String_t2->strings_length - 1 - way2)) == 0))
        {
            way1++;
            way2++;
        }
        else if (isalpha(*(*String_t1->strings_adresses + String_t1->strings_length - 1 - way1)) == 0)
        {
            way1++;
            
        }
        else if (isalpha(*(*String_t2->strings_adresses + String_t2->strings_length - 1 - way2)) == 0)
        {
            way2++;
